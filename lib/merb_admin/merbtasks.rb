namespace :slices do
  namespace :merb_admin do
    ...
    desc "Freeze MerbAdmin into your app (only merb_admin/app)" 
    ...
    namespace :freeze do
      ...
      desc "Freezes MerbAdmin by copying all files from merb_admin/app to your application"
      task :app do
        puts "Copying all merb_admin/app files to your application - resolves any collisions"
      ...
      desc "Freezes MerbAdmin as a gem and copies over merb_admin/app"
